...
For storing the data, a csv file will automatically be created during the installation phase inside the project hidden folder if you are on a mac or linux.
